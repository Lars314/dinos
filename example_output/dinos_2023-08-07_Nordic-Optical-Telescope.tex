...
\begin{center}
    ...
    \tcbhighmath[frame style image=report_images/grad.jpg,interior style image=report_images/title_interior.jpg, boxrule=2pt]{\text{\huge 2023-08-07 Nordic Optical Telescope}}
    \\[1cm]
...
\begin{center}
    \includegraphics[width=1.0\textwidth]{./output/all_sky_map.jpg}
\end{center}
...
\begin{minipage}{0.6\textwidth}
    \includegraphics[width=9cm]{./output/local_sky.jpg}
\vspace{-2cm}
...
\begin{center}
    \includegraphics[width=0.75\textwidth]{./output/airmass.jpg}
...
\DIV[1]{section}*{Finder Chart NGC6302}\label{Ueff}
%\vspace{0.2cm}

\begin{minipage}{0.6\textwidth}
    \includegraphics[width=9cm]{./output/finder_NGC6302.jpg}
\vspace{-2cm}
...
\DIV[1]{section}*{Finder Chart 2023lgy}\label{Ueff}
%\vspace{0.2cm}

\begin{minipage}{0.6\textwidth}
    \includegraphics[width=9cm]{./output/finder_2023lgy.jpg}
\vspace{-2cm}
...
\DIV[1]{section}*{Finder Chart Vega}\label{Ueff}
%\vspace{0.2cm}

\begin{minipage}{0.6\textwidth}
    \includegraphics[width=9cm]{./output/finder_Vega.jpg}
\vspace{-2cm}
